...
using RenderTexture = struct RenderTexture
{
...
using NPatchInfo = struct NPatchInfo
{
...
using GlyphInfo = struct GlyphInfo
{
...
using Camera3D = struct Camera3D
{
...
using Camera2D = struct Camera2D
{
...
// MaterialMap
using MaterialMap = struct MaterialMap
{
...
using BoneInfo = struct BoneInfo
{
...
// ModelAnimation
using ModelAnimation = struct ModelAnimation
{
	int         boneCount;          // Number of bones
...
using RayCollision = struct RayCollision
{
...
using rAudioBuffer    = struct rAudioBuffer;
using rAudioProcessor = struct rAudioProcessor;

// AudioStream, custom audio stream
using AudioStream = struct AudioStream
{
...
using VrDeviceInfo = struct VrDeviceInfo
{
...
using VrStereoConfig = struct VrStereoConfig
{
...
// File path list
using FilePathList = struct FilePathList
{
...
// Automation event
using AutomationEvent = struct AutomationEvent
{
...
using AutomationEventList = struct AutomationEventList
{
...
using ShaderLocationIndex = enum
{
...
using ShaderUniformDataType = enum
{
...
using ShaderAttributeDataType = enum
{
...
using SaveFileTextCallback = bool(*)(const char *fileName, char *text); // FileIO: Save text data
