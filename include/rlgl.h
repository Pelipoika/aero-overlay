...
using rlDrawCall = struct rlDrawCall
{
...
// rlRenderBatch type
using rlRenderBatch = struct rlRenderBatch
{
...
using rlShaderLocationIndex = enum
{
...
using rlShaderUniformDataType = enum
{
...
using rlShaderAttributeDataType = enum
{
...
using rlFramebufferAttachType = enum
{
...
using rlFramebufferAttachTextureType = enum
{
